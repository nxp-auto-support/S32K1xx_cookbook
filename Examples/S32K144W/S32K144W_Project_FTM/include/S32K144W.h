...
**     Reference manual:    S32K1xx RM Rev12 Draft B
**     Version:             1.0
**     Build:               b191023
**
**     Abstract:
...
/* Check if another memory map has not been also included */
  ...
  #error S32K144W_M4 memory map: There is already included another memory map. Only one memory map can be included.
...
typedef enum {
  ...
  FTFC_EEERAM_ECC_ERR_IRQn     = 152,              /**< FFTC EEERAM ECC error */
  FTFC_Mgate_ECC_ERR_IRQn      = 153               /**< FFTC Mgate ECC error */
} IRQn_Type;
...
#include "system_S32K144W_M4.h"        /* Device specific configuration file */
...
} RGPIO_Type, *RGPIO_MemMapPtr;

/** Number of instances of the RGPIO module. */
#define RGPIO_INSTANCE_COUNT                     (5u)
...
#define RGPIO_BASE_ADDRS                         { GPIOA_BASE, GPIOB_BASE, GPIOC_BASE, GPIOD_BASE, GPIOE_BASE }
/** Array initializer of RGPIO peripheral base pointers */
#define RGPIO_BASE_PTRS                          { GPIOA, GPIOB, GPIOC, GPIOD, GPIOE }
...
#define RGPIO_PDOR_PDO_WIDTH                     (32U)
...
#define RGPIO_PSOR_PTSO_WIDTH                    (32U)
...
#define RGPIO_PCOR_PTCO_WIDTH                    (32U)
...
#define RGPIO_PTOR_PTTO_WIDTH                    (32U)
...
#define RGPIO_PDIR_PDI_WIDTH                     (32U)
...
#define RGPIO_PDDR_PDD_WIDTH                     (32U)
...
/*! @{ */
#define RGPIO_PIDR_PID_MASK                      (0xFFFFFFFFU)
#define RGPIO_PIDR_PID_SHIFT                     (0U)
#define RGPIO_PIDR_PID_WIDTH                     (32U)
#define RGPIO_PIDR_PID(x)                        (((uint32_t)(((uint32_t)(x)) << RGPIO_PIDR_PID_SHIFT)) & RGPIO_PIDR_PID_MASK)
/*! @} */
...
typedef struct {
  __IO uint32_t TRGMUXn[TRGMUX_TRGMUXn_COUNT];     /**< TRGMUX DMAMUX0 Register..TRGMUX LPTMR0_REG Register, array offset: 0x0, array step: 0x4 */
...
/*! @name TRGMUXn - TRGMUX DMAMUX0 Register..TRGMUX LPTMR0_REG Register */
/*! @{ */
...
#define TRGMUX_ADC0_REG_INDEX 3
#define TRGMUX_ADC1_REG_INDEX 4
#define TRGMUX_CMP0_REG_INDEX 7
#define TRGMUX_FTM0_REG_INDEX 10
#define TRGMUX_FTM1_REG_INDEX 11
#define TRGMUX_FTM2_REG_INDEX 12
#define TRGMUX_FTM3_REG_INDEX 13
#define TRGMUX_PDB0_REG_INDEX 14
#define TRGMUX_PDB1_REG_INDEX 15
#define TRGMUX_FLEXIO_REG_INDEX 17
#define TRGMUX_LPIT0_REG_INDEX 18
#define TRGMUX_LPUART0_REG_INDEX 19
#define TRGMUX_LPUART1_REG_INDEX 20
#define TRGMUX_LPI2C0_REG_INDEX 21
#define TRGMUX_LPSPI0_REG_INDEX 23
#define TRGMUX_LPSPI1_REG_INDEX 24
#define TRGMUX_LPTMR0_REG_INDEX 25
